...
public class InsertStudentForStatisticsPageGUI implements Initializable
{
	@FXML
	Button BeckButton;
	@FXML
	...
	{
		Parent root = FXMLLoader.load(getClass().getResource("InsertStudentForStatisticsPage.fxml"));
