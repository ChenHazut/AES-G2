...
public class ReportMenuGUI implements Initializable {
	...
	// @FXML
	// private TableColumn <Exam,String> executionIDCol;
	// @FXML
	...
	public void start(Stage primaryStage) throws Exception {
		Parent root = FXMLLoader.load(getClass().getResource("ReportMenu.fxml"));
	...
	// teacherNameCol.setCellValueFactory(new
	// PropertyValueFactory<>("teacherName"));
